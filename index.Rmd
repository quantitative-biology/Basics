...
of Biology, with a cross-appointment to Applied Mathematics. Kim has a PhD in
biology (yet was once told she was too mathematical for a position in a biology
department). She has several projects designed to improve worked on quantitative
...
climate change -- [see ecotheory.ca](https://ecotheory.ca){target="_blank"}.
...
to the Departments of Biology and Chemical Engineering. Brian has a PhD in mathematics (and everyone has always been too in awe of him to make remarks about what positions he is qualified for). He is the author of
...
This e-book was last compiled on `r format(Sys.time(), '%d %B, %Y')`.
